...
public class MysticItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(Registry.ITEM_REGISTRY, MysticsBiomes.modId);
    ...
    public static final RegistryObject<Item> STRAWBERRY_SIGN = ITEMS.register("strawberry_sign", () -> new SignItem((new Item.Properties()).stacksTo(16).tab(MysticBlockItem.TAB), MysticBlocks.STRAWBERRY_SIGN.get(), MysticBlocks.STRAWBERRY_WALL_SIGN.get()));
    public static final RegistryObject<Item> STRAWBERRY_BOAT = ITEMS.register("strawberry_boat", () -> new MysticBoatItem(false, MysticBoat.Type.STRAWBERRY, (new Item.Properties()).stacksTo(1).tab(MysticBlockItem.TAB)));
    ...
    public static final RegistryObject<Item> CITRUS_BOAT = ITEMS.register("citrus_boat", () -> new MysticBoatItem(false, MysticBoat.Type.CITRUS, (new Item.Properties()).stacksTo(1).tab(MysticBlockItem.TAB)));
    public static final RegistryObject<Item> CITRUS_CHEST_BOAT = ITEMS.register("citrus_chest_boat", () -> new MysticBoatItem(true, MysticBoat.Type.CITRUS, (new Item.Properties()).stacksTo(1).tab(MysticBlockItem.TAB)));
    ...
    public static final RegistryObject<Item> MAPLE_BOAT = ITEMS.register("maple_boat", () -> new MysticBoatItem(false, MysticBoat.Type.MAPLE, (new Item.Properties()).stacksTo(1).tab(MysticBlockItem.TAB)));
    public static final RegistryObject<Item> MAPLE_CHEST_BOAT = ITEMS.register("maple_chest_boat", () -> new MysticBoatItem(true, MysticBoat.Type.MAPLE, (new Item.Properties()).stacksTo(1).tab(MysticBlockItem.TAB)));
    ...
    public static final RegistryObject<Item> JACARANDA_BOAT = ITEMS.register("jacaranda_boat", () -> new MysticBoatItem(false, MysticBoat.Type.JACARANDA, (new Item.Properties()).stacksTo(1).tab(MysticBlockItem.TAB)));
    public static final RegistryObject<Item> JACARANDA_CHEST_BOAT = ITEMS.register("jacaranda_chest_boat", () -> new MysticBoatItem(true, MysticBoat.Type.JACARANDA, (new Item.Properties()).stacksTo(1).tab(MysticBlockItem.TAB)));
    ...
    public static final RegistryObject<Item> STRAWBERRY_MILK_BUCKET = ITEMS.register("strawberry_milk_bucket", () -> new MilkBucketItem((new Item.Properties().tab(MysticBlockItem.TAB)).craftRemainder(Items.BUCKET).stacksTo(1)));
    public static final RegistryObject<Item> STRAWBERRY = ITEMS.register("strawberry", () -> new ItemNameBlockItem(MysticBlocks.STRAWBERRY_BUSH.get(), (new Item.Properties().tab(MysticBlockItem.TAB).food(new FoodProperties.Builder().nutrition(2).fast().build()))));
    public static final RegistryObject<Item> SWEET_STRAWBERRY = ITEMS.register("sweet_strawberry", () -> new Item((new Item.Properties().tab(MysticBlockItem.TAB).food((new FoodProperties.Builder()).nutrition(4).saturationMod(1.2F).effect(() -> new MobEffectInstance(MobEffects.REGENERATION, 100, 1), 1.0F).build()))));
    public static final RegistryObject<Item> STRAWBERRY_CAKE = ITEMS.register("strawberry_cake", () -> new MysticBlockItem(MysticBlocks.STRAWBERRY_CAKE));
    public static final RegistryObject<Item> PINK_FROSTED_CAKE = ITEMS.register("pink_frosted_cake", () -> new MysticBlockItem(MysticBlocks.PINK_FROSTED_CAKE));
    public static final RegistryObject<Item> ORANGE_FROSTED_CAKE = ITEMS.register("orange_frosted_cake", () -> new MysticBlockItem(MysticBlocks.ORANGE_FROSTED_CAKE));
    public static final RegistryObject<Item> YELLOW_FROSTED_CAKE = ITEMS.register("yellow_frosted_cake", () -> new MysticBlockItem(MysticBlocks.YELLOW_FROSTED_CAKE));
    public static final RegistryObject<Item> LIME_FROSTED_CAKE = ITEMS.register("lime_frosted_cake", () -> new MysticBlockItem(MysticBlocks.LIME_FROSTED_CAKE));
    public static final RegistryObject<Item> CYAN_FROSTED_CAKE = ITEMS.register("cyan_frosted_cake", () -> new MysticBlockItem(MysticBlocks.CYAN_FROSTED_CAKE));
    public static final RegistryObject<Item> PURPLE_FROSTED_CAKE = ITEMS.register("purple_frosted_cake", () -> new MysticBlockItem(MysticBlocks.PURPLE_FROSTED_CAKE));

    public static final RegistryObject<Item> PINK_EGG = ITEMS.register("pink_egg", () -> new MysticEggItem(new Item.Properties().stacksTo(16).tab(MysticBlockItem.TAB)));
    public static final RegistryObject<Item> ORANGE_EGG = ITEMS.register("orange_egg", () -> new MysticEggItem(new Item.Properties().stacksTo(16).tab(MysticBlockItem.TAB)));
    public static final RegistryObject<Item> YELLOW_EGG = ITEMS.register("yellow_egg", () -> new MysticEggItem(new Item.Properties().stacksTo(16).tab(MysticBlockItem.TAB)));
    public static final RegistryObject<Item> LIME_EGG = ITEMS.register("lime_egg", () -> new MysticEggItem(new Item.Properties().stacksTo(16).tab(MysticBlockItem.TAB)));
    public static final RegistryObject<Item> CYAN_EGG = ITEMS.register("cyan_egg", () -> new MysticEggItem(new Item.Properties().stacksTo(16).tab(MysticBlockItem.TAB)));
    public static final RegistryObject<Item> PURPLE_EGG = ITEMS.register("purple_egg", () -> new MysticEggItem(new Item.Properties().stacksTo(16).tab(MysticBlockItem.TAB)));

    public static final RegistryObject<Item> STRAWBERRY_COW_SPAWN_EGG = ITEMS.register("strawberry_cow_spawn_egg", () -> new ForgeSpawnEggItem(MysticEntities.STRAWBERRY_COW, 16642812, 16756181, new Item.Properties().tab(MysticBlockItem.TAB)));
    public static final RegistryObject<Item> RAINBOW_CHICKEN_SPAWN_EGG = ITEMS.register("rainbow_chicken_spawn_egg", () -> new ForgeSpawnEggItem(MysticEntities.RAINBOW_CHICKEN, 9891273, 15386466, new Item.Properties().tab(MysticBlockItem.TAB)));
    public static final RegistryObject<Item> RED_PANDA_SPAWN_EGG = ITEMS.register("red_panda_spawn_egg", () -> new ForgeSpawnEggItem(MysticEntities.RED_PANDA, 16752225, 12933923, new Item.Properties().tab(MysticBlockItem.TAB)));
    public static final RegistryObject<Item> BUTTERFLY_SPAWN_EGG = ITEMS.register("butterfly_spawn_egg", () -> new ForgeSpawnEggItem(MysticEntities.BUTTERFLY, 1656127, 3857605, new Item.Properties().tab(MysticBlockItem.TAB)));
