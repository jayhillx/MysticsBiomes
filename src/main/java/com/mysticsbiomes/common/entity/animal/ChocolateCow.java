...
public class ChocolateCow extends AnimalEntity {

    public ChocolateCow(EntityType<? extends ChocolateCow> entity, World level) {
        super(entity, level);
    }
    ...
    @Override
    public ChocolateCow createChild(ServerWorld level, PassiveEntity mob) {
        return MysticEntities.CHOCOLATE_COW.create(level);
    }
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if (stack.isOf(Items.BUCKET) && !this.isBaby()) {
            ...
            ItemStack stack1 = ItemUsage.exchangeStack(stack, player, MysticItems.CHOCOLATE_MILK_BUCKET.getDefaultStack());
