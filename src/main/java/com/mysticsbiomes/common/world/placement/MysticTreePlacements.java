...
public class MysticTreePlacements {
    ...
    public static final ResourceKey<PlacedFeature> CITRUS_TREE_CHECKED = createKey("tree_citrus_checked");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        Holder<ConfiguredFeature<?, ?>> CITRUS_TREE = getter.getOrThrow(MysticTreeFeatures.CITRUS_TREE);
        ...
        PlacementUtils.register(context, CITRUS_TREE_CHECKED, CITRUS_TREE, VegetationPlacements.treePlacement(RarityFilter.onAverageOnceEvery(3), Blocks.CACTUS));
