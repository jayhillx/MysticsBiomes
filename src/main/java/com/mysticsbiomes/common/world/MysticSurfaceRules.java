...
public class MysticSurfaceRules {
    ...
    private static SurfaceRules.RuleSource mysticRule() {
        ...
        return SurfaceRules.ifTrue(SurfaceRules.isBiome(MysticBiomes.LUSH_OASIS.getKey()), lushSand);
    }
