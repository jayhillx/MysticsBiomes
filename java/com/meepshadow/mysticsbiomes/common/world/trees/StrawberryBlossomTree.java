...
public class StrawberryBlossomTree extends Tree {
    ...
    protected ConfiguredFeature<TreeFeatureConfig, ?> getTreeFeature(Random randomIn, boolean p_225546_2_) {
        return randomIn.nextInt(10) == 0 ? Feature.FANCY_TREE.withConfiguration(p_225546_2_ ? ModFeatures.FANCY_STRAWBERRY_BLOSSOM_TREE_CONFIG : ModFeatures.FANCY_STRAWBERRY_BLOSSOM_TREE_CONFIG) : Feature.NORMAL_TREE.withConfiguration(p_225546_2_ ? ModFeatures.STRAWBERRY_BLOSSOM_TREE_CONFIG : ModFeatures.STRAWBERRY_BLOSSOM_TREE_CONFIG);
    }
}
