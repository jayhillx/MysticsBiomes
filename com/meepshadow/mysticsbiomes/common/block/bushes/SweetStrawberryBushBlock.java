package com.meepshadow.mysticsbiomes.common.block.bushes;
...
public class SweetStrawberryBushBlock extends BushBlock implements IGrowable {
    ...
    public SweetStrawberryBushBlock(Properties p_i49971_1_) {
        super(p_i49971_1_);
    ...
    public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
        return new ItemStack(ModItem.SWEET_STRAWBERRY.get());
    }
    ...
    public ActionResultType onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (!flag && player.getHeldItem(handIn).getItem() == Items.BONE_MEAL) {
            ...
            spawnAsEntity(worldIn, pos, new ItemStack(ModItem.SWEET_STRAWBERRY.get(), j + (flag ? 1 : 0)));
