...
public class MysticBiomes {
    ...
    public static void bootstrap(BootstapContext<Biome> context) {
        ...
        context.register(STRAWBERRY_FIELDS, OverworldBiomes.plains(feature, carver, false, false, false));
        context.register(LAVENDER_MEADOW, OverworldBiomes.plains(feature, carver, false, false, false));
        context.register(BAMBOO_BLOSSOM_FOREST, OverworldBiomes.plains(feature, carver, false, false, false));
        context.register(AUTUMNAL_GROVE, OverworldBiomes.plains(feature, carver, false, false, false));
        context.register(LUSH_OASIS, OverworldBiomes.plains(feature, carver, false, false, false));
        context.register(LAGOON, OverworldBiomes.plains(feature, carver, false, false, false));
        context.register(TROPICS, OverworldBiomes.plains(feature, carver, false, false, false));
    }
