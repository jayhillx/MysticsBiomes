...
public class MysticBlockEntities {
    ...
    public static Supplier<BlockEntityType<?>> SIGN;
    public static Supplier<BlockEntityType<?>> HANGING_SIGN;
    ...
    private static Supplier<BlockEntityType<?>> register(String name, Supplier<BlockEntityType.Builder<?>> builder) {
