...
public class MysticTabs {
    public static final DeferredRegister<CreativeModeTab> TABS = REGISTRY_FACTORY.create(Registries.CREATIVE_MODE_TAB, MysticsBiomes.modId);

    public static final RegistryObject<CreativeModeTab> TAB = register("tab", () -> CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0)
            ...
            .displayItems((parameters, output) -> {
                ...
                ///output.accept(MysticItems.VANILLA_MILK_BUCKET.get());
                ///output.accept(MysticItems.CHOCOLATE_MILK_BUCKET.get());

                output.accept(MysticItems.STRAWBERRY_CAKE.get());
                output.accept(MysticItems.SWEET_STRAWBERRY_CAKE.get());
                output.accept(MysticItems.CHOCOLATE_CAKE.get());
                output.accept(MysticItems.VANILLA_CAKE.get());
                ...
                ///output.accept(MysticItems.CHERRY_PIE.get());
                ///output.accept(MysticItems.PEACH_PIE.get());
                ...
                ///output.accept(MysticItems.VANILLA_COW_SPAWN_EGG.get());
                ///output.accept(MysticItems.CHOCOLATE_COW_SPAWN_EGG.get());
                ///output.accept(MysticItems.RAINBOW_CHICKEN_SPAWN_EGG.get());
                ///output.accept(MysticItems.RED_PANDA_SPAWN_EGG.get());
                ///output.accept(MysticItems.SEA_OTTER_SPAWN_EGG.get());
