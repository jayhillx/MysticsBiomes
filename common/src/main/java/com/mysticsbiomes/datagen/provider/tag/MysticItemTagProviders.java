...
public class MysticItemTagProviders extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(ItemTags.LEAVES)
                ...
                ///.add(MysticItems.BUTTERFLY_BUSH_LEAVES.get())
        ...
        this.tag(ItemTags.SAPLINGS)
                ...
                ///.add(MysticItems.BUTTERFLY_BUSH.get())
        ...
        this.tag(ItemTags.SMALL_FLOWERS)
                ...
                .add(MysticItems.SAGUARO_BLOSSOM.get())
    ...
    private void generateFor(MysticBlockFamily family) {
        family.getVariants().forEach((variant, block) -> {
            ...
            switch (variant) {
                case PLANKS -> this.tag(ItemTags.PLANKS).add(block.get().asItem());
                case STAIRS -> this.tag(flammable ? ItemTags.WOODEN_STAIRS : ItemTags.STAIRS).add(block.get().asItem());
                case SLAB -> this.tag(flammable ? ItemTags.WOODEN_SLABS : ItemTags.SLABS).add(block.get().asItem());
                case FENCE -> this.tag(flammable ? ItemTags.WOODEN_FENCES : ItemTags.FENCES).add(block.get().asItem());
                case FENCE_GATE -> this.tag(ItemTags.FENCE_GATES).add(block.get().asItem());
                case BUTTON -> this.tag(flammable ? ItemTags.WOODEN_BUTTONS : ItemTags.STONE_BUTTONS).add(block.get().asItem());
                case PRESSURE_PLATE -> {
                    if (flammable) {
                        this.tag(ItemTags.WOODEN_PRESSURE_PLATES).add(block.get().asItem());
                    }
                }
                case TRAPDOOR -> this.tag(flammable ? ItemTags.WOODEN_TRAPDOORS : ItemTags.TRAPDOORS).add(block.get().asItem());
                case DOOR -> this.tag(flammable ? ItemTags.WOODEN_DOORS : ItemTags.DOORS).add(block.get().asItem());
                case SIGN -> this.tag(ItemTags.SIGNS).add(block.get().asItem());
                case HANGING_SIGN -> this.tag(ItemTags.HANGING_SIGNS).add(block.get().asItem());
                case WALL -> this.tag(ItemTags.WALLS).add(block.get().asItem());
            }
        });
    }
